    ...
    return (
        <div className="space-y-12 sm:space-y-16 lg:space-y-24">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-8">
                    <h2 className="text-3xl font-serif text-gray-800 dark:text-gray-100">{featuredCollection.title}</h2>
                    <p className="mt-2 text-gray-500 dark:text-gray-400">{featuredCollection.description}</p>
                </div>
                {isLoadingGrid ? (
                    <GridSkeleton />
                ) : (
