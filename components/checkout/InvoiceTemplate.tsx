...
import { Order, Promotion, SiteSettings, ContactDetails, DeliverySettings } from '../../types';
...
const InvoiceTemplate: React.FC<InvoiceTemplateProps> = ({ order, promotions, siteSettings, contactDetails, deliverySettings, invoiceData }) => {
