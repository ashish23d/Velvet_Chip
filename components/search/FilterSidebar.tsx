...
const FilterSidebar: React.FC<FilterSidebarProps> = ({
  ...
  availableAttributes = {},
  selectedAttributes = {},
  onAttributeToggle = (_k: string, _v: string) => { }
}) => {
  ...
  const hasActiveFilters = selectedSizes.length > 0 || priceRange.min > minPrice || priceRange.max < maxPrice || selectedRating !== null || minDiscount !== null || includeOutOfStock || (Object.values(selectedAttributes) as string[][]).some(arr => arr.length > 0);
